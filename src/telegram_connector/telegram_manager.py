...
from telethon.tl.functions.auth import CheckPhoneRequest, SendCodeRequest, SignUpRequest
from telethon.tl.types import UpdateShortChatMessage, UpdateShortMessage
from telethon.utils import get_display_name

from telegram_connector.telethon_future import SessionPasswordNeededError
...
class InteractiveTelegramClient(TelegramClient):
    ...
    def __init__(self, session_user_id, user_phone, api_id, api_hash,
        ...
        if not self.connect():  #   telethon.errors.FloodWaitError: (FloodWaitError(...), 'Too many requests were made too fast. Must wait 13 seconds.')
